...
class Wallet(object):
    ...
    def generate_blockchain_address(self):
        ...
        #5
        sha256_1_nbpk = hashlib.sha256(network_bitcoin_public_key_bytes)
        sha256_1_nbpk_digest = sha256_1_nbpk.digest()
        sha256_2_nbpk = hashlib.sha256(sha256_1_nbpk_digest)
...
if __name__ == '__main__':
    ...
    t = Transaction(wallet.private_key, wallet.public_key, wallet.blockchain_address,
                    'B', 1.0)
